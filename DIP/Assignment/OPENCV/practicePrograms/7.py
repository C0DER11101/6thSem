...
while(True):
    ...
    mask=cv2.inRange(hsv, lower_blue, upper_blue); # returns a new image/a mask containing those pixels in the given range between lower_blue and upper_blue that need to be removed.
